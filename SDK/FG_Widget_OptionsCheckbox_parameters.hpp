...
struct UWidget_OptionsCheckbox_C_HandleChecked_Params
{
	bool*                                              IsChecked;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Widget_OptionsCheckbox.Widget_OptionsCheckbox_C.UpdateCheckboxValue
struct UWidget_OptionsCheckbox_C_UpdateCheckboxValue_Params
{
};
...
struct UWidget_OptionsCheckbox_C_OnInitValueController_Params
{
};
...
struct UWidget_OptionsCheckbox_C_OnOptionValueUpdated_Params
{
};
