...
public:
	...
	class UParticleSystemComponent*                    GasPuff_01;                                               // 0x0388(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	void ExecuteUbergraph_BP_GasPillar_01(int* EntryPoint);
};
