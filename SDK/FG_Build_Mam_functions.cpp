...
#include "FG_Build_Mam_parameters.hpp"
...
struct FText ABuild_Mam_C::GetLookAtDecription(class AFGCharacterPlayer** byCharacter, struct FUseState* State)
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_Mam.Build_Mam_C.GetLookAtDecription");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_Mam.Build_Mam_C.IsUseable");
...
void ABuild_Mam_C::UpdateUseState(class AFGCharacterPlayer** byCharacter, struct FVector* atLocation, class UPrimitiveComponent** componentHit, struct FUseState* out_useState)
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_Mam.Build_Mam_C.UpdateUseState");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_Mam.Build_Mam_C.UserConstructionScript");
