...
#include "FG_Widget_DynamicOptionsRow_classes.hpp"
...
struct UWidget_DynamicOptionsRow_C_InitOptionRow_Params
{
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.OnMouseEnter
struct UWidget_DynamicOptionsRow_C_OnMouseEnter_Params
{
...
struct UWidget_DynamicOptionsRow_C_OnMouseLeave_Params
{
	struct FPointerEvent*                              MouseEvent;                                               // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.PreConstruct
struct UWidget_DynamicOptionsRow_C_PreConstruct_Params
{
...
struct UWidget_DynamicOptionsRow_C_BndEvt__mButton_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature_Params
{
};
...
struct UWidget_DynamicOptionsRow_C_BndEvt__mButton_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature_Params
{
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.OnOptionRowInit
struct UWidget_DynamicOptionsRow_C_OnOptionRowInit_Params
{
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.OnOptionValueUpdated
struct UWidget_DynamicOptionsRow_C_OnOptionValueUpdated_Params
{
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.ExecuteUbergraph_Widget_DynamicOptionsRow
struct UWidget_DynamicOptionsRow_C_ExecuteUbergraph_Widget_DynamicOptionsRow_Params
{
	int*                                               EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Widget_DynamicOptionsRow.Widget_DynamicOptionsRow_C.OnClicked__DelegateSignature
struct UWidget_DynamicOptionsRow_C_OnClicked__DelegateSignature_Params
{
};
