...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x02E0(0x00A0) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x0380(0x001C) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AckermannAccuracy;                                        // 0x039C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVehicleTransmissionData                    TransmissionSetup;                                        // 0x03A0(0x0030) (Edit)
	struct FRuntimeFloatCurve                          SteeringCurve;                                            // 0x03D0(0x0088) (Edit)
