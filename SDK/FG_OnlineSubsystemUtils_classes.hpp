...
public:
	...
	class UCreateSessionCallbackProxy* STATIC_CreateSession(class UObject** WorldContextObject, class APlayerController** PlayerController, int* PublicConnections, bool* bUseLAN, bool* bIsPrivateGame, class FString* SessionName);
};
