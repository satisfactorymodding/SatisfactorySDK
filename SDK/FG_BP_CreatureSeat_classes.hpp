...
public:
	...
	class USpringArmComponent*                         SpringArm;                                                // 0x03E8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        Cube;                                                     // 0x03F0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	void InpActEvt_Use_K2Node_InputActionEvent_2(struct FKey* Key);
	void InpActEvt_Jump_Drift_K2Node_InputActionEvent_1(struct FKey* Key);
